        ...
        <div className="container">
          <div className="row">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li>
                  <a href="mailto:rahul14kumar2004@gmail.com?body=fell free to type">
                    Gmail
                  </a>
                </li>
                <li>
            ...
            <div className="footer-col">
              ...
              <div className="social-links">
                <a
                  href="https://www.linkedin.com/in/rahul-kumar-716045207/"
                  target="blank"
                >
                  <FaLinkedin className=" mx-auto mt-3 scale-125" />
                </a>
                <a href="https://twitter.com/KumarRahul3748" target="blank">
                  <FaTwitter className=" mx-auto mt-3 scale-125" />
                </a>

                <a href="https://www.instagram.com/officialrahulsamyal/" target="blank">
